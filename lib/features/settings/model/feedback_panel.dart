        ...
        child: ListBody(
          children: <Widget>[
            ...
            RatingBar.builder(
              ...
              itemSize: 20.0, // Adjust the size to your preference, 20.0 is just an example
            ),
            SizedBox(height: 8),  // Add some space between the rating bar and text field
            TextField(
              controller: _reviewController,
              decoration: InputDecoration(
                hintText: AppLocalizations.of(context)!.writeReview,
                border: OutlineInputBorder(), // Add a border to the TextField
                contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 8), // Reduce padding
              ),
